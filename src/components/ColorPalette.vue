<template>
    ...
    <main class="row-span-10 bg-main-area pb-5 pt-6 duration-1000 dark:bg-slate-900">
        <CardContainer v-if="selectedPalette === 0">
            <ColorCard v-for="card in openCards" :key="card" :card-number="card" :selected-palette="0" />
        </CardContainer>
        <CardContainer v-else-if="selectedPalette === 1">
